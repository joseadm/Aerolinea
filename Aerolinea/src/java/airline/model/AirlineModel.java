...
public class AirlineModel {
    ...
    public List<Vuelo> getPromo() throws ParseException {
        ...
        Vuelo[] promo = {
        new Vuelo(1,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MIA","Miami","USA"),true, 100,""),
        new Vuelo(2,new Ciudad("MIA","Miami","USA"),new Ciudad("CAN","Cancun","Mexico"),true,200,""),
        new Vuelo(3,new Ciudad("MAD","Madrid","Espana"),new Ciudad("ROM","Roma","Italia"),true,200,""),
        new Vuelo(4,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MAD","Madrid","Espana"),true,100,""),
        new Vuelo(5,new Ciudad("MIA","Miami","USA"),new Ciudad("SJO","San Jose","Costa Rica"),true,40,""),
        new Vuelo(6,new Ciudad("VIE","Viena","Austria"),new Ciudad("MAD","Madrid","Espana"),true,60,"")
        };
    ...
    public List<Vuelo> getVuelos() throws ParseException{
        ...
        Vuelo [] vuelos = {
            ...
            new Vuelo(5,new Ciudad("MIA","Miami","USA"),new Ciudad("SJO","San Jose","Costa Rica"),true,40,""),
            new Vuelo(6,new Ciudad("VIE","Viena","Austria"),new Ciudad("MAD","Madrid","Espana"),true,60,""),
            new Vuelo(7,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MIA","Miami","USA"),true, 100,""),
            new Vuelo(8,new Ciudad("MIA","Miami","USA"),new Ciudad("CAN","Cancun","Mexico"),true,200,""),
            new Vuelo(9,new Ciudad("MAD","Madrid","Espana"),new Ciudad("ROM","Roma","Italia"),true,200,""),
            new Vuelo(10,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MAD","Madrid","Espana"),true,100,""),
            new Vuelo(11,new Ciudad("MIA","Miami","USA"),new Ciudad("SJO","San Jose","Costa Rica"),true,40,""),
            new Vuelo(12,new Ciudad("VIE","Viena","Austria"),new Ciudad("MAD","Madrid","Espana"),true,60,""),
            new Vuelo(13,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MIA","Miami","USA"),true, 100,""),
            new Vuelo(14,new Ciudad("MIA","Miami","USA"),new Ciudad("CAN","Cancun","Mexico"),true,200,""),
            new Vuelo(15,new Ciudad("MAD","Madrid","Espana"),new Ciudad("ROM","Roma","Italia"),true,200,""),
            new Vuelo(16,new Ciudad("SJO","San Jose","Costa Rica"),new Ciudad("MAD","Madrid","Espana"),true,100,""),
            new Vuelo(17,new Ciudad("MIA","Miami","USA"),new Ciudad("SJO","San Jose","Costa Rica"),true,40,""),
            new Vuelo(18,new Ciudad("VIE","Viena","Austria"),new Ciudad("MAD","Madrid","Espana"),true,60,"")
        };
